...
class MainActivity : AppCompatActivity() {
    ...
    private val permLauncher = registerForActivityResult(
        ...
        if (!granted) showSnack("⚠ Storage permission needed for downloads")
    }
    ...
    private fun observeViewModel() {
        ...
        vm.downloads.observe(this) { list ->
            ...
            b.tvDownloadsHeader.visibility = if (list.isEmpty()) View.GONE else View.VISIBLE
            b.rvDownloads.visibility = if (list.isEmpty()) View.GONE else View.VISIBLE
        }
    }
    ...
    private fun showVideoInfo(info: VideoInfo) {
        ...
        // Download button — shows quality picker
    ...
    private fun showQualityDialog(info: VideoInfo) {
        ...
        MaterialAlertDialogBuilder(this, R.style.EkoDialog)
            ...
            .setItems(labels) { _, i ->
                ...
                showSnack("⬇ Download started: ${formats[i].quality}")
            }
